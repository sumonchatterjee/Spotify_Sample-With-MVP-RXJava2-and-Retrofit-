 ...
 * }</pre>
 * <p>
 * To process the result the receiving activity ({@code LoginActivity} in this drawers_layout) needs to override one of its
...
public class AuthenticationClient {
    ...
    interface AuthenticationClientListener {
         ...
         * for drawers_layout because of underlying LoginActivity was paused or stopped.
     ...
     * activities; for drawers_layout Fragments.
     * <pre>{@code
     * // To start LoginActivity from a Fragment:
     * Intent intent = AuthenticationClient.createLoginActivityIntent(getActivity(), request);
     * startActivityForResult(intent, REQUEST_CODE);
